...
const bookDbConfig = {
    host: process.env.BOOK_DB_HOST || 'iae-db',
    user: 'root',
    port: process.env.BOOK_DB_PORT || 3306,
    password: process.env.BOOK_DB_PASSWORD || process.env.MYSQL_ROOT_PASSWORD || 'rootpass',
    database: 'books',
...
const memberDbConfig = {
    host: process.env.MEMBER_DB_HOST || 'iae-db',
    user: 'root',
    port: process.env.MEMBER_DB_PORT || 3306,
    password: process.env.MEMBER_DB_PASSWORD || process.env.MYSQL_ROOT_PASSWORD || 'rootpass',
    database: 'member',
    waitForConnections: true,
    connectionLimit: 10,
    queueLimit: 0
...
const loanDbConfig = {
    host: process.env.LOAN_DB_HOST || 'iae-db',
    user: 'root',
    port: process.env.LOAN_DB_PORT || 3306,
    password: process.env.LOAN_DB_PASSWORD || process.env.MYSQL_ROOT_PASSWORD || 'rootpass',
    database: 'loans',
    waitForConnections: true,
    connectionLimit: 10,
    queueLimit: 0
...
const adminDbConfig = {
    host: process.env.ADMIN_DB_HOST || 'iae-db',
    user: 'root',
    port: process.env.ADMIN_DB_PORT || 3306,
    password: process.env.ADMIN_DB_PASSWORD || process.env.MYSQL_ROOT_PASSWORD || 'rootpass',
    database: 'admin',
    waitForConnections: true,
    connectionLimit: 10,
    queueLimit: 0
